...
<hr>
  ...
  <ul>
    ...
    <li> 9:15 – 10:15: <b>Keynote: Prof. Ye Zhu</b> </li>
    ...
    <li> 2:00 – 3:00: <b>Keynote: Prof. Jie Ren</b> </li>
...
<div class="row">
<div class="col-sm-12 clearfix">
  <img src="{{ site.url }}{{ site.baseurl }}/images/astad3/PangGuansong.jpg" class="rounded-circle" width="25%" style="aspect-ratio: 1; border-radius:50%;float: left" />
